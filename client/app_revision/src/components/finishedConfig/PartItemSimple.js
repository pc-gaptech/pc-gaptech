    ...
    >
      <Grid item xs={3} className={classes.center}>
        ...
        <Button
          ...
          onClick={() => {
            history.push(
              `/configurator/parts/${component}/${
                data[`findOne${component}ById`].id
              }`
            );
          }}
        >
      ...
      >
        <Typography className={classes.center}>{`Rp. ${data[
          `findOne${component}ById`
        ].price.toLocaleString("id")}`}</Typography>
      </Grid>
